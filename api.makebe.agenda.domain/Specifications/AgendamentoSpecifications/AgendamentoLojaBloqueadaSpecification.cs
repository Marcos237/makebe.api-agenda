...
namespace api.makebe.agenda.domain.Specifications.AgendamentoSpecifications
{
    ...
    public class AgendamentoLojaBloqueadaSpecification : Specification<AgendamentoDTO>
    {
        private readonly IAgendamentoLojaRepository _agendamentoLojaRepository;
        public AgendamentoLojaBloqueadaSpecification(IAgendamentoLojaRepository agendamentoLojaRepository)
        {
        ...
        public override bool IsSatisfiedBy(AgendamentoDTO item)
        {
            ...
            var response = _agendamentoLojaRepository.BuscarAgendamentoLojaBloqueada(id, dataIncio, dataFim).Result;
            return !response.Any();
        }
    }
}
