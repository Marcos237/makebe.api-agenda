        ...
        public UsuarioDTOToColaboradorDTOMap()
        {
            CreateMap<UsuarioDTO, ColaboradorDTO>()
                ...
                .ForMember(dest => dest.UsuarioId, opt => opt.MapFrom(src =>
                    string.IsNullOrWhiteSpace(src.Id) ? (Guid?)null : PropiedadesHelper.ParseGuidOrDefault(src.Id)))
                .ForMember(dest => dest.Nome, opt => opt.MapFrom(src => src.Nome))
                .ForMember(dest => dest.Cpf, opt => opt.MapFrom(src => src.Cpf))
                .ForMember(dest => dest.Email, opt => opt.MapFrom(src => src.Email))
                .ForMember(dest => dest.Instagram, opt => opt.MapFrom(src => src.Instagran))
                .ForMember(dest => dest.Telefone, opt => opt.MapFrom(src => src.Telefone))
                .ForMember(dest => dest.PermissaoId, opt => opt.MapFrom(src => src.PermissaoId))
