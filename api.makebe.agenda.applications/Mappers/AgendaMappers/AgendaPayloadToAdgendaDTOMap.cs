...
{
    public class AgendaPayloadToAdgendaDTOMap : Profile
    {
        public AgendaPayloadToAdgendaDTOMap()
        {
            CreateMap<AgendaDTO, AgendaPayload>()
               ...
               .ForMember(dest => dest.AgendaBloqueadaInicio, opt => opt.MapFrom(src => src.AgendaBloqueadaInicio))
               .ForMember(dest => dest.AgendaBloqueadaFim, opt => opt.MapFrom(src => src.AgendaBloqueadaFim))
